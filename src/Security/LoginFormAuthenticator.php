...
class LoginFormAuthenticator extends AbstractFormLoginAuthenticator implements PasswordAuthenticatedInterface
{
     ...
     *   Vérifier si on se trouve sur la page de connexion et 
     *  que l'on a envoyé le formulaire 
    */
    ...
    */
    ...
    public function checkCredentials($credentials, UserInterface $user)
    {
        ...
        if ($user->getIsConfirmed() !== true){
            throw new CustomUserMessageAuthenticationException('Vous devez confirmer votre adresse');
        }
    ...
    public function getPassword($credentials): ?string
    {
       ...
       /**
     * 4.Action à effectuer aprés avoir été connecté 
     */
